...
public class GL6_PassOb {
    public static void main(String[] args) {
        ...
        System.out.println(" ob имеет те же размеры, что и ob2: " + ob1.sameBlock(ob2));
        System.out.println(" ob имеет те же размеры, что и ob3: " + ob1.sameBlock(ob3));
        System.out.println(" ob имеет тот же объём, что и ob3: " + ob1.sameVolume(ob3));
    }
}
